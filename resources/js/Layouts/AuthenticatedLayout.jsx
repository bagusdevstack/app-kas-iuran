                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            <div className="flex shrink-0 items-center">
                                <Link href={auth.user.role === 'bendahara' ? route('admin.dashboard') : route('dashboard')}>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    href={auth.user.role === 'bendahara' ? route('admin.dashboard') : route('dashboard')}
                                    active={route().current('dashboard') || route().current('admin.dashboard')}
                                >
                                    Dashboard
                                </NavLink>

                                {/* Menu Payments (Muncul untuk semua/role tertentu) */}
                                {/* <NavLink
                                ...
                                {auth.user.role === 'bendahara' && (
                                    <NavLink
                                        href={route('laporan.kas')}
                                        active={route().current('laporan.kas')}
                                    >
                                        Laporan Kas
                                    </NavLink>
                                )}
                                ...
                                {auth.user.role === 'bendahara' && (
                                    <NavLink
                                        ...
                                        active={route().current('pembayaran.create')}
                                    >
                                        💰 Input Kas/Iuran Warga
                                    </NavLink>
                                )}
